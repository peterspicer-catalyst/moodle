...
$string['cleartemporaryfilesonfailure'] = 'Clear temporary files on failure';
$string['cleartemporaryfilesonfailure_help'] = 'Clears the temporary files immediately if a backup fails to be produced successfully.';
